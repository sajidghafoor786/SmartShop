...
<div class="modal fade" id="editProduct">
    <div class="modal-dialog modal-xl">
        <div class="modal-content bg">
            ...
            <!-- Modal body -->
            <form action="<?php echo e(url('products/update')); ?>" id="productFormUpdate" class="productForm"
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <div class="input-group input-group-static mb-4">
                                                ...
                                                <textarea class="form-control" rows="5" name="short_description"
                                                    ...
                                                    placeholder="Say a few words what you're add here on."
                                                    spellcheck="true"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-3">
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <div class="ms-2">
                                        ...
                                        <img src="<?php echo e(asset('upload/products_img/' . $product_img->image)); ?>"
                                            class="avatar avatar-xl me-3 border-radius-lg" style="width: 1000px;"
                                            alt="user1">
                                        <?php endif; ?>
                                    </div>
                                    <span
                                ...
                                <td class="td-actions text-right">
                                    ...
                                    <button type="button" class="btn btn-success btn-icon-only editbtn"
                                        value="<?php echo e($item->id); ?>"><span class="btn-inner--icon text-center"><i
...
<div class="modal fade" id="addProduct">
    <<<<<<< HEAD <div class="modal-dialog modal-xl ">
        =======
        <div class="modal-dialog modal-xl">
            >>>>>>> 047d38f7e7c4f4d0268c9d7ae846aeb3b3110f5b
            <div class="modal-content bg">
                                        ...
                                        <div class="form-row">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <div class="input-group input-group-static mb-4">
                                                        <label>barcode</label>
                                                        <input type="text" class="form-control" name="b_code" required>
                                                    </div>
                                                </div>
                                            </div>
...
>>>>>>> 047d38f7e7c4f4d0268c9d7ae846aeb3b3110f5b
    ...
    << << < HEAD
        ...
        // triggle methed for open modal show sub category
        >>>
        >>> > 047 d38f7e7c4f4d0268c9d7ae846aeb3b3110f5b
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SmartShop\resources\views/admin/pages/product.blade.php ENDPATH**/ ?>