          ...
          <div class="row align-items-center d-none d-lg-flex justify-content-between">
              <div class="col-lg-4 logo">
                  <a href="<?php echo e(route('user.home')); ?>" class="text-decoration-none"
                      >
                      <img src="<?php echo e(asset('logo/book-mart.png')); ?>" style="height: 100px; width: 150px;object-fit: cover; ">
                  </a>
              </div>
              ...
              <div class="col-lg-6 col-6 text-left  d-flex justify-content-end align-items-center">
                  ...
                  <form action="<?php echo e(route('user.shop')); ?>" method="GET">
                      <div class="input-group">
                          <input type="text" placeholder="Type Search...." value="<?php echo e(Request::get('Search')); ?>"
...
<?php /**PATH C:\xampp\htdocs\SmartShop\resources\views/user/include/header.blade.php ENDPATH**/ ?>