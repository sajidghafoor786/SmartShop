<aside
    ...
    <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white  {{ Request::is('/') ? 'bg-gradient-primary' : '' }}"
                    href="{{ url('/') }}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Request::is('sub_category') ? 'bg-gradient-primary' : '' }} "
                    href="{{ url('sub_category') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Request::is('brands') ? 'bg-gradient-primary' : '' }}  "
                    href="{{ url('brands') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Request::is('shipping') ? 'bg-gradient-primary' : '' }}  "
                    href="{{ url('shipping') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Request::is('coupen') ? 'bg-gradient-primary' : '' }}  "
                    href="{{ url('coupen') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Request::is('order*', 'order-details*') ? 'bg-gradient-primary' : '' }}"
                    href="{{ url('order') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
