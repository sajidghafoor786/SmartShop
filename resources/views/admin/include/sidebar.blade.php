<aside class="sidenav navbar  navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main" style="z-index:111;">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand" href="{{ url('/Dashboard') }}">
            <img src="{{ asset('admin-2/assets-2/logo/logo-2.png') }}" class="navbar-brand-img text-white" alt="main_logo">
    ...
    <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white  {{ Request::is('/dashboard') ? 'bg-gradient-primary' : '' }}" href="{{ url('/') }}">
